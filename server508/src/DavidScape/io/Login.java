...
//HD AND LD END
                ...
                if (p.rights == 1) {
                    p.frames.sendMessage(p, "Welcome back <img=0>" + p.username);
                    for (Player ap : Engine.players) {
                        if (ap == null)
                            continue;
                        if (!ap.online)
                            continue;
                        ap.frames.sendMessage(ap, "Mod <img=0>" + p.username + " has logged in.");
                    }
                }
                if (p.rights == 2) {
                    ...
                    for (Player ap : Engine.players) {
                        ...
                        if (!ap.online)
                            continue;
                        ap.frames.sendMessage(ap, "Admin <img=1>" + p.username + " has logged in.");
                    }
                }
                ...
                p.friendsLoggedIn();
                p.frames.sendMessage(p, "Welcome to DavidScape, the official 508 server for the MoparScape client");
                p.frames.sendMessage(p, "by: Davidi2");
