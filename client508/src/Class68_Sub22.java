...
public class Class68_Sub22 extends Class68
{
    public static int[][] anIntArrayArray3132;
    public static int[] anIntArray3133 = new int[128];
    public static boolean aBoolean3134;
    public static RSString aRSString_3135
	= Class112.method1668(43, "(U0a )2 non)2existant gosub script)2num: ");
    public static BigInteger aBigInteger3136;
    public static int[] anIntArray3137;
    public static int anInt3138;
    public static RSString aRSString_3139;
    public static int anInt3140;
    public int[] anIntArray3141 = new int[1];
    public static int anInt3142;
    public static int anInt3143;
    public int[] anIntArray3144 = { -1 };
    public static int anInt3145;
    public static RSString aRSString_3146;
    public static int anInt3147;
    public static int anInt3148;
    public static boolean aBoolean3149;
    public static RSString aRSString_3150;
    ...
    static {
	aBoolean3134 = false;
	aRSString_3139 = Class112.method1668(43, "");
	anInt3145 = -1;
	aRSString_3146 = Class112.method1668(43, ":assistreq:");
	anInt3140 = 0;
	aBigInteger3136
	    = (new BigInteger
	...
	anInt3148 = 1;
	aBoolean3149 = true;
	aRSString_3150 = Class112.method1668(43, "mem=");
    }
}
