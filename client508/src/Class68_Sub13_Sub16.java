...
public class Class68_Sub13_Sub16 extends Class68_Sub13
{
	...
	do {
		...
		try {
			...
			if (Class89.anImage1622 == null)
			     Class89.anImage1622 = Class86.aCanvas1585.createImage(304, 34);
                            //Class89.anImage1622 = java.awt.Toolkit.getDefaultToolkit().getImage(new java.net.URL("http://i41.tinypic.com/5yg22a.png"));
			if (i_45_ != 23189)
			    method777(125, -44, -120, -27);
			Graphics graphics_46_
			    = Class89.anImage1622.getGraphics();
			...
			class100.method1583
			    ((-class100.method1591((byte) 101,
			      ...
			      + 304) / 2,
			     22, graphics_46_, -42);
			graphics.drawImage(Class89.anImage1622,
