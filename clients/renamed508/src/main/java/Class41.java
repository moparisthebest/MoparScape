...
final class Class41
{
    ...
    private static boolean[] aBooleanArray703;
    private static int[] anIntArray704;
    private int[] anIntArray705;

    private static final int method468(int[] is, int i)
    {
        int i_0_ = is[i];
        int i_1_ = -1;
        int i_2_ = 2147483647;
    ...
    private final void method469(int i, int i_5_)
    {
        if (i < i_5_)
        {
            int i_6_ = i;
    ...
    final boolean method471()
    {
        ...
        int i_13_ = Class92.method1532(i_12_ - 1, (byte) 58);
        ...
        for (int i_15_ = 0; i_15_ < anIntArray700.length; i_15_++)
        {
            ...
            int i_20_ = 0;
            if (i_18_ > 0)
                i_20_ = Class68_Sub21.aClass24Array3125[anIntArray702[i_16_]].method383();
            for (int i_21_ = 0; i_21_ < i_17_; i_21_++)
            {
                int i_22_ = anIntArrayArray698[i_16_][i_20_ & i_19_];
                i_20_ >>>= i_18_;
                anIntArray697[i_14_++] = (i_22_ >= 0 ? Class68_Sub21.aClass24Array3125[i_22_].method383() : 0);
            }
        }
        return true;
    }

    final void method472(float[] fs, int i)
    {
        ...
        for (int i_25_ = 2; i_25_ < i_23_; i_25_++)
        {
            ...
            int i_28_ = method473(anIntArray704[i_26_], anIntArray697[i_26_], anIntArray704[i_27_], anIntArray697[i_27_], anIntArray704[i_25_]);
            ...
            if (i_29_ != 0)
            {
                ...
                if (i_29_ >= i_32_)
                    anIntArray697[i_25_] = (i_30_ > i_31_ ? i_29_ - i_31_ + i_28_ : i_28_ - i_29_ + i_30_ - 1);
                else
                    anIntArray697[i_25_] = ((i_29_ & 0x1) != 0 ? i_28_ - (i_29_ + 1) / 2 : i_28_ + i_29_ / 2);
            } else
            {
    ...
    private final int method473(int i, int i_52_, int i_53_, int i_54_, int i_55_)
    {
    ...
    private static final int method474(int[] is, int i)
    {
        int i_61_ = is[i];
        int i_62_ = -1;
    ...
    private final void method475(int i, int i_66_, int i_67_, int i_68_, float[] fs, int i_69_)
    {
