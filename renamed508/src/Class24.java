...
final class Class24
{
    ...
    private float[][] aFloatArrayArray506;
    private int anInt507;
    private int[] anIntArray508;
    private int[] anIntArray509;

    final float[] method380()
    {
        return aFloatArrayArray506[method383()];
    }

    private static final int method381(int i, int i_0_)
    {
        int i_1_;
        for (i_1_ = (int) Math.pow((double) i, 1.0 / (double) i_0_) + 1; Class68_Sub19.method997(i_0_, i_1_, 107) > i; i_1_--)
        {
            /* empty */
        }
        return i_1_;
            ...
            if (i_13_ != 0)
            {
                ...
                for (int i_16_ = 0; i_16_ < i_13_; i_16_++)
                {
                    ...
                    if (i_15_ >= anIntArray509.length)
                    {
                        ...
                        for (int i_19_ = 0; i_19_ < anIntArray509.length; i_19_++)
    ...
    Class24()
    {
        ...
        ((Class24) this).anInt504 = Class68_Sub21.method1190(16);
        ...
        if (bool)
        {
            ...
            while (i < anInt507)
            {
                int i_21_ = (Class68_Sub21.method1190(Class92.method1532(anInt507 - i, (byte) -108)));
        ...
        if (i > 0)
        {
            ...
            float f_24_ = Class68_Sub21.method1197(Class68_Sub21.method1190(32));
            int i_25_ = Class68_Sub21.method1190(4) + 1;
            boolean bool_26_ = Class68_Sub21.method1196() != 0;
            int i_27_;
            if (i == 1)
                i_27_ = method381(anInt507, ((Class24) this).anInt504);
            else
                i_27_ = anInt507 * ((Class24) this).anInt504;
            anIntArray505 = new int[i_27_];
            for (int i_28_ = 0; i_28_ < i_27_; i_28_++)
                anIntArray505[i_28_] = Class68_Sub21.method1190(i_25_);
            aFloatArrayArray506 = new float[anInt507][((Class24) this).anInt504];
            if (i == 1)
            {
                for (int i_29_ = 0; i_29_ < anInt507; i_29_++)
                {
                    float f_30_ = 0.0F;
                    int i_31_ = 1;
                    for (int i_32_ = 0; i_32_ < ((Class24) this).anInt504; i_32_++)
                    {
                        int i_33_ = i_29_ / i_31_ % i_27_;
                        float f_34_ = (float) anIntArray505[i_33_] * f_24_ + f + f_30_;
            ...
            } else
            {
                ...
                {
                    float f_36_ = 0.0F;
                    int i_37_ = i_35_ * ((Class24) this).anInt504;
                    for (int i_38_ = 0; i_38_ < ((Class24) this).anInt504; i_38_++)
                    {
                        float f_39_ = (float) anIntArray505[i_37_] * f_24_ + f + f_36_;
    ...
    {
        int i;
        for (i = 0; anIntArray509[i] >= 0; i = Class68_Sub21.method1196() != 0 ? anIntArray509[i] : i + 1)
        {
            /* empty */
        }
