...
final class Class42
{
    private Class5 aClass5_706;
    private int[] anIntArray707 = new int[5];
    private static int[] anIntArray708;
    private Class5 aClass5_709;
    private Class5 aClass5_710;
    int anInt711 = 0;
    int anInt712 = 500;
    private Class6 aClass6_713;
    private static int[] anIntArray714 = new int[32768];
    private static int[] anIntArray715;
    private int anInt716;
    private static int[] anIntArray717;
    private int anInt718;
    private Class5 aClass5_719;
    private Class5 aClass5_720;
    private static int[] anIntArray721;
    private int[] anIntArray722 = new int[5];
    private Class5 aClass5_723;
    private static int[] anIntArray724;
    private Class5 aClass5_725;
    private Class5 aClass5_726;
    private static int[] anIntArray727;
    private int[] anIntArray728;
    private static int[] anIntArray729;
    ...
    final int[] method477(int i, int i_0_)
    {
        ...
        if (aClass5_723 != null)
        {
            ...
            i_1_ = (int) ((double) (((Class5) aClass5_723).anInt102 - ((Class5) aClass5_723).anInt98) * 32.768 / d);
            i_2_ = (int) ((double) ((Class5) aClass5_723).anInt98 * 32.768 / d);
        }
        int i_4_ = 0;
        int i_5_ = 0;
        int i_6_ = 0;
        if (aClass5_730 != null)
        {
            ...
            i_4_ = (int) ((double) (((Class5) aClass5_730).anInt102 - ((Class5) aClass5_730).anInt98) * 32.768 / d);
            i_5_ = (int) ((double) ((Class5) aClass5_730).anInt98 * 32.768 / d);
        }
        for (int i_7_ = 0; i_7_ < 5; i_7_++)
        {
            if (anIntArray722[i_7_] != 0)
            {
                ...
                anIntArray727[i_7_] = (int) ((double) (((Class5) aClass5_709).anInt102 - ((Class5) aClass5_709).anInt98) * 32.768 * Math.pow(1.0057929410678534, (double) anIntArray707[i_7_]) / d);
                anIntArray721[i_7_] = (int) ((double) ((Class5) aClass5_709).anInt98 * 32.768 / d);
            }
        }
        for (int i_8_ = 0; i_8_ < i; i_8_++)
        {
            ...
            if (aClass5_723 != null)
            {
                ...
                i_9_ += method478(i_3_, i_12_, ((Class5) aClass5_723).anInt100) >> 1;
            ...
            if (aClass5_730 != null)
            {
                ...
                i_10_ = i_10_ * ((method478(i_6_, i_14_, ((Class5) aClass5_730).anInt100) >> 1) + 32768) >> 15;
            ...
            for (int i_15_ = 0; i_15_ < 5; i_15_++)
            {
                if (anIntArray722[i_15_] != 0)
                {
                    ...
                    if (i_16_ < i)
                    {
                        anIntArray715[i_16_] += method478(anIntArray724[i_15_], i_10_ * anIntArray717[i_15_] >> 15, ((Class5) aClass5_709).anInt100);
                        anIntArray724[i_15_] += (i_9_ * anIntArray727[i_15_] >> 16) + anIntArray721[i_15_];
                    }
                }
            }
        }
        if (aClass5_706 != null)
        {
            ...
            for (int i_19_ = 0; i_19_ < i; i_19_++)
            {
                ...
                int i_22_;
                if (bool_18_)
                    i_22_ = (((Class5) aClass5_706).anInt98 + ((((Class5) aClass5_706).anInt102 - ((Class5) aClass5_706).anInt98) * i_20_ >> 8));
                else
                    i_22_ = (((Class5) aClass5_706).anInt98 + ((((Class5) aClass5_706).anInt102 - ((Class5) aClass5_706).anInt98) * i_21_ >> 8));
                i_17_ += 256;
                if (i_17_ >= i_22_)
                {
                    i_17_ = 0;
        ...
        if (anInt716 > 0 && anInt718 > 0)
        {
            ...
            for (int i_24_ = i_23_; i_24_ < i; i_24_++)
                anIntArray715[i_24_] += anIntArray715[i_24_ - i_23_] * anInt718 / 100;
        }
        if (((Class6) aClass6_713).anIntArray111[0] > 0 || ((Class6) aClass6_713).anIntArray111[1] > 0)
        {
            ...
            if (i >= i_26_ + i_27_)
            {
                ...
                {
                    int i_30_ = (int) (((long) anIntArray715[i_28_ + i_26_] * (long) Class6.anInt113) >> 16);
                    for (int i_31_ = 0; i_31_ < i_26_; i_31_++)
                        i_30_ += (int) (((long) (anIntArray715[i_28_ + i_26_ - 1 - i_31_]) * (long) (Class6.anIntArrayArray112[0][i_31_])) >> 16);
                    for (int i_32_ = 0; i_32_ < i_28_; i_32_++)
                        i_30_ -= (int) (((long) anIntArray715[i_28_ - 1 - i_32_] * (long) (Class6.anIntArrayArray112[1][i_32_])) >> 16);
                ...
                for (;;)
                {
                    ...
                    for (/**/; i_28_ < i_29_; i_28_++)
                    {
                        int i_33_ = (int) (((long) anIntArray715[i_28_ + i_26_] * (long) Class6.anInt113) >> 16);
                        for (int i_34_ = 0; i_34_ < i_26_; i_34_++)
                            i_33_ += (int) (((long) (anIntArray715[i_28_ + i_26_ - 1 - i_34_]) * (long) (Class6.anIntArrayArray112[0][i_34_])) >> 16);
                        for (int i_35_ = 0; i_35_ < i_27_; i_35_++)
                            i_33_ -= (int) (((long) (anIntArray715[i_28_ - 1 - i_35_]) * (long) (Class6.anIntArrayArray112[1][i_35_])) >> 16);
                ...
                for (/**/; i_28_ < i; i_28_++)
                {
                    ...
                    for (int i_37_ = i_28_ + i_26_ - i; i_37_ < i_26_; i_37_++)
                        i_36_ += (int) (((long) (anIntArray715[i_28_ + i_26_ - 1 - i_37_]) * (long) (Class6.anIntArrayArray112[0][i_37_])) >> 16);
                    for (int i_38_ = 0; i_38_ < i_27_; i_38_++)
                        i_36_ -= (int) (((long) anIntArray715[i_28_ - 1 - i_38_] * (long) (Class6.anIntArrayArray112[1][i_38_])) >> 16);
    ...
    private final int method478(int i, int i_40_, int i_41_)
    {
        if (i_41_ == 1)
        {
            if ((i & 0x7fff) < 16384)
    ...
    final void method479(Stream class68_sub14)
    {
        ...
        ((Class42) this).anInt712 = class68_sub14.readUShort();
        ((Class42) this).anInt711 = class68_sub14.readUShort();
    ...
    static
    {
        ...
        for (int i = 0; i < 32768; i++)
            anIntArray708[i] = (int) (Math.sin((double) i / 5215.1903) * 16384.0);
